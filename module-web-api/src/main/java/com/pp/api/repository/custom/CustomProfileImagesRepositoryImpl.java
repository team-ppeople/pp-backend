...
import com.pp.api.entity.QProfileImages;
...
public class CustomProfileImagesRepositoryImpl extends QuerydslRepositorySupport
        implements CustomProfileImagesRepository {

    private final JPAQueryFactory jpaQueryFactory;

    public CustomProfileImagesRepositoryImpl(JPAQueryFactory jpaQueryFactory) {
        super(QProfileImages.class);
